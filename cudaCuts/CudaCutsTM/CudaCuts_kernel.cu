		...
		int graph_size, int width, int rows, int graph_size1, int width1, int rows1 )
{
		...
		if( thid < graph_size1 && g_relabel_mask[thid] == 1 && x < width-1 && x > 0 && y < rows-1 && y > 0 )
		{
            ...
            __tbegin(); 
				g_push_reser[thid] -= min_flow_pushed;
            __tcommit(); 
			}
         ...
         __tbegin(); 
			if(temp_weight > 0 && flow_push > 0 && height_fn[temp_mult] == height_fn[temp_mult - 1] + 1 )
			{
				(temp_weight < flow_push) ? min_flow_pushed = temp_weight : 0;
				temp_weight = temp_weight - min_flow_pushed ;
				g_left_weight[thid] -= min_flow_pushed;
				g_right_weight[thid-1] += min_flow_pushed;
				g_push_reser[thid] -= min_flow_pushed;
				g_push_reser[thid-1] += min_flow_pushed;
         ...
         __tbegin(); 
			if(temp_weight > 0 && flow_push > 0 && height_fn[temp_mult] == height_fn[temp_mult - 34] + 1)
			{
				...
				g_up_weight[thid] -= min_flow_pushed;
				g_down_weight[thid-width1] += min_flow_pushed;
				g_push_reser[thid] -= min_flow_pushed;
				g_push_reser[thid-width1] += min_flow_pushed;
         ...
         __tbegin(); 
			if(temp_weight > 0 && flow_push > 0 && height_fn[temp_mult] == height_fn[temp_mult + 1] + 1 )
			{
				(temp_weight < flow_push) ? min_flow_pushed = temp_weight : 0 ;
				temp_weight = temp_weight - min_flow_pushed ;
				g_right_weight[thid] -= min_flow_pushed;
				g_left_weight[thid+1] += min_flow_pushed;
				g_push_reser[thid] -= min_flow_pushed;
				g_push_reser[thid+1] += min_flow_pushed;
         ...
         __tbegin(); 
			if(temp_weight > 0 && flow_push > 0 && height_fn[temp_mult] == height_fn[temp_mult + 34] + 1 )
			{
				(temp_weight<flow_push) ? min_flow_pushed = temp_weight : 0 ;
				temp_weight = temp_weight - min_flow_pushed ;
				g_down_weight[thid] -= min_flow_pushed;
				g_up_weight[thid+width1] += min_flow_pushed;
				g_push_reser[thid] -= min_flow_pushed;
				g_push_reser[thid+width1] += min_flow_pushed;
